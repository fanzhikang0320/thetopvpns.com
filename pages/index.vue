      ...
      <div class="product_container_title_box">
        ...
        <div class="disclosure_box">
          <div class="disclosure_title" @click="showDisclosure">
            ...
            <span class="text">Advertising Disclosure</span>
          </div>
          <div class="disclosure_content">
            <p>TopVPN.com is reader-supported. We may earn commissions if you buy a VPN through links on our site.</p>
            <p>We built this website around our core principles of openness, honesty and transparency. Your trust is of the utmost importance to us, which is why we’ll always be straight-up about how we review VPNs.</p>
            <p>Every VPN goes through a standardized, rigorous, and in-depth test programme comprised of hours and hours of use at the hands of our experts. This means you can buy with confidence knowing that our reviews are fully up to date. To find out more, please take a look at How We Review VPNs.</p>
            <p>When it comes to keeping our website running we are going to be entirely upfront with you on how we operate, how we make money, and how we can keep the site a free resource for our millions of visitors. Our aim is to put you, the reader, first and foremost at all times.</p>

            <ul>
              <li>We will never accept money to review a product</li>
              <li>We will never accept money to change a product review</li>
              <li>We will never accept money to turn a blind eye to an issue or flaw</li>
              <li>We will never accept money to bias our research or investigations</li>
            </ul>
      ...
      <div class="product_list_container">
        <div class="product_item" v-for="(product,index) in productData" :key="index">
          <div :class="{'special_corner_box':true,'first': index == 0, 'second': index == 1, 'third': index == 2}" v-if="index < 3 ">
            <span class="most" v-if="index == 2">Fastest VPN</span>
          ...
          <!-- <a :href="product.link" class="product_link_box" target="_blank" rel="noopener noreferrer"> -->
            <div class="product_item_content">
              ...
              <div class="btn-box">
                <a :href="product.link" class="visit_btn" :data-key="product.key" target="_blank" rel="noopener noreferrer nofollow" @click.self="execute">Visit {{product.name}}</a>
                <a :href="product.link" class="text-link" :data-key="product.key" target="_blank" rel="noopener noreferrer nofollow" @click.self="execute" v-if="product.speaker && product.speaker != ''"><span class="volume-icon"></span><span>{{product.speaker}}</span></a>
                <span v-if="product.key == 'surfshark'" style="margin-top: 10px;display:inline-block;"><del style="margin-right: 5px;">$19.25/mo</del><span style="color: #e83f60;font-weight:bold;">$2.49/mo</span></span>
              </div>
